...
function displayProductDetails(product) {
    ...
    // Update availability
    const availabilityElement = document.querySelector('p.mb-2:nth-of-type(2) strong');
    ...
    if (descTabContent) {
        ...
        descTabContent.innerHTML = product.productDetails || product.description || "No detailed description available";
    }
...
function setupImageSlider(product) {
    ...
    try {
        ...
        if (typeof jQuery !== 'undefined' && jQuery('.slider-for').hasClass('slick-initialized')) {
            jQuery('.slider-for').slick('unslick');
        }
        if (typeof jQuery !== 'undefined' && jQuery('.slider-nav').hasClass('slick-initialized')) {
...
function populateEditForm(product) {
    ...
    setTimeout(() => {
        ...
        if (typeof editor2 === "object" && editor2 !== null && typeof editor2.destroy === "function") {
            editor2.destroy();
        }
