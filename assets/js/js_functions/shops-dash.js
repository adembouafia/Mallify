      ...
      allShops.forEach((shop) => {
        ...
        const shopItem = {
          ...
          owner: {
            ...
            avatar:
              shop.vendor && shop.vendor.vendorImage ? `/uploads/${shop.vendor.vendorImage}` : "/uploads/admin.jpg",
          },
        ...
        <div class="shop-details">
            ...
            <div class="shop-details-body">
                ...
                <div class="shop-owner-info">
                    <img src="${shop.vendor && shop.vendor.vendorImage ? `/uploads/${shop.vendor.vendorImage}` : "/assets/images/dashboard/admin.jpg"}" alt="Owner" class="shop-owner-avatar">
                    <div>
...
function updateLocalShopData(updatedShop) {
  const shopItem = {
    ...
    owner: {
      ...
      avatar:
        updatedShop.vendor && updatedShop.vendor.vendorImage
          ? `/uploads/${updatedShop.vendor.vendorImage}`
          : "/uploads/admin.jpg",
    },
...
function deleteShop(shopId) {
  ...
  xhr.onload = () => {
    if (xhr.status >= 200 && xhr.status < 300) {
      ...
      shopToast(`Error deleting shop: ${xhr.status} ${xhr.statusText}`, "danger")
...
function updateTabPagination(tabId, totalItems, paginationSettings) {
  const paginationWrapper = document.querySelector(`#${tabId} .pagination-wrapper .pagination`)
  ...
  paginationWrapper.querySelectorAll(".page-link").forEach((link) => {
    link.addEventListener("click", function (e) {
      ...
      if (page === "prev" && currentPage > 1) {
        ...
        paginationSettings.currentPage = Number.parseInt(page)
      }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    ...
    const sortDropdownItems = document.querySelectorAll(".tab-actions .dropdown-item")
    ...
    if (selectAllCheckbox) {
      selectAllCheckbox.addEventListener("change", function () {
        ...
        const checkboxes = document.querySelectorAll("#approved tbody .form-check-input")
